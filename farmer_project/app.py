...
#mongodb+srv://sharmaajay:Qf7LUqn4Z6vmnNa9@farmerproject.mgwfz.mongodb.net/?retryWrites=true&w=majority&appName=farmerproject
...
def predict(): 
    if request.method == 'POST': 
        ...
        # return f"your cluster nuumber is {cluster}"
